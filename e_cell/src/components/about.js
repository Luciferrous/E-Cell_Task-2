       ...
       <div className='' >
        ...
        <div className='p-2 flex flex-col justify-center'>
              ...
              <div className='flex flex-col'>
                ...
                <p  data-aos="flip-left" className='text-3xl font-bold text-white p-2 animate-pulse aos-init aos-animate '>More About Us</p>
                </div>
                

                <div className='mr-[30px] ml-[30px] flex-[0.6] bg-back text-white p-[50px] mt-2 mb-[20px] p-2 text-justify rounded-xl'>
