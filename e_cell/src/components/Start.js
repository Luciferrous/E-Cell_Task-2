  ...
  return (
    <>
        ...
        <div className='flex flex-col lg:flex-row justify-around items-center bg-back '>
                 ...
                 <div className='m-3 Card border rounded-2xl bg-white w-[250px]' onMouseEnter={()=>setval1(!val1)} onMouseLeave={()=>setval1(!val1)}>
                     ...
                     <div className=' info flex flex-col justify-around' >
                        ...
                        <div className={`border rounded-2xl  ${!val1?'hidden':''} bg-sec h-[250px] p-2  text-justify text-white `}>
                          <p className=" text-cyan-300 font-bold">{data[0].about}</p>
                        </div>
                  ...
                  <div className='m-3 Card border rounded-2xl bg-white w-[250px]'  onMouseEnter={()=>setval2(!val2)} onMouseLeave={()=>setval2(!val2)}>
                     ...
                     <div className='info flex flex-col justify-around' onMouseEnter={()=>setval2(!val2)} onMouseLeave={()=>setval2(!val2)}>
                        ...
                        <div className={`border rounded-2xl ${!val2?'hidden':''} bg-sec h-[250px] p-2 text-justify text-white `}>
                          <p className=" text-cyan-300 font-bold">{data[1].about}</p>
                        </div>
                  ...
                  <div className='m-3 Card border rounded-2xl bg-white w-[250px]'  onMouseEnter={()=>setval3(!val3)} onMouseLeave={()=>setval3(!val3)}>
                     ...
                     <div className='info flex flex-col justify-around' onMouseEnter={()=>setval3(!val3)} onMouseLeave={()=>setval3(!val3)}>
                        ...
                        <div className={`border rounded-2xl ${!val3?'hidden':''} bg-sec h-[250px] p-2 text-justify text-white `}>
                          <p className=" text-cyan-300 font-bold">{data[2].about}</p>
                        </div>
                  ...
                  <div className='m-3 Card border rounded-2xl bg-white w-[250px] transform duration-300'  onMouseEnter={()=>setval4(!val4)} onMouseLeave={()=>setval4(!val4)}>
                     <div className='w-[250px] h-[250px]'>
                     <div className='info flex flex-col justify-around'>
                        ...
                        <div className={`border rounded-2xl ${!val4?'hidden':''} bg-sec h-[250px] p-2 text-justify text-white `}>
                          <p className=" text-cyan-300 font-bold">{data[3].about}</p>
                        </div>
                  ...
                  <div className='m-3 Card border rounded-2xl bg-white w-[250px]' onMouseEnter={()=>setval5(!val5)} onMouseLeave={()=>setval5(!val5)}>
                     <div className='w-[250px] h-[250px]'>
                     <div className='info flex flex-col justify-around' >
                        ...
                        <div className={`border rounded-2xl ${!val5?'hidden':''} bg-sec h-[250px]  p-2 text-justify text-white `}>
                          <p className=" text-cyan-300 font-bold">{data[4].about}</p>
                        </div>
